  ...
  return (
    <section className="about-section" id="future">
      <div className="main-container">
        <h1 className="about-me-heading">Present and Future plans</h1>
        ...
        <p className="hero-section-description">
          In the future I plan to start a university in computer science. I also
          plan to learn the following FrontEnd technologies: TypeScript, Sass,
          Tailwind, Redux and Next.js.
          <br />
          ...
          technologies such as Express.js, Authentication and Security, EJS and
          Databases (Sql especially PostgreSQL).
        </p>
        <p className="hero-section-description">
